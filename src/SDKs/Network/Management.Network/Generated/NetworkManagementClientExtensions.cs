...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class NetworkManagementClientExtensions
    {
            ...
            /// needed.
            /// </param>
            public static VirtualWanSecurityProviders BeginSupportedSecurityProviders(this INetworkManagementClient operations, string resourceGroupName, string virtualWANName)
            {
                return operations.BeginSupportedSecurityProvidersAsync(resourceGroupName, virtualWANName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<VirtualWanSecurityProviders> BeginSupportedSecurityProvidersAsync(this INetworkManagementClient operations, string resourceGroupName, string virtualWANName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginSupportedSecurityProvidersWithHttpMessagesAsync(resourceGroupName, virtualWANName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
