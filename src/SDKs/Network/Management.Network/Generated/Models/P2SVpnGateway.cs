...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class P2SVpnGateway : Resource
    {
        ...
        public P2SVpnGateway(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SubResource virtualHub = default(SubResource), string provisioningState = default(string), int? vpnGatewayScaleUnit = default(int?), SubResource p2sVpnServerConfiguration = default(SubResource), AddressSpace vpnClientAddressPool = default(AddressSpace), IList<VpnClientConnectionHealth> vpnClientConnectionHealth = default(IList<VpnClientConnectionHealth>), string etag = default(string))
